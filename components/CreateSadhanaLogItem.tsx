...
const CreateSadhanaLogItem = ({
  ...
  const {
    ...
    result,
    loading,
    error: createSadhanaError,
    isCompleted,
    reset,
  } = useFrappePostCall(
    "prapannam_sadhana.prapannam_sadhana.api.sadhana.create_sadhana_log_and_items"
  );

  const { sadhanaLog, setSadhanaLog, sadhanaTypes } =
    useContext(SadhanaContext);
      ...
      <View style={styles.modalContent}>
        <View style={styles.titleContainer}>
          ...
          <Pressable onPress={onDismiss}>
            ...
            <Text style={{ color: "white" }} text50H>
              X
            </Text>
          </Pressable>
        </View>
